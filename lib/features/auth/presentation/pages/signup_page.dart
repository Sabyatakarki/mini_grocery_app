...
import 'package:lost_n_found/features/auth/presentation/state/batch_state.dart';
import 'package:lost_n_found/features/auth/presentation/view_model/auth_view_model.dart';
import 'package:lost_n_found/features/auth/presentation/view_model/batch_view_model.dart';
...
//  final List<BatchEntity> _batches = [ ];
  ...
  Future<void> _handleSignup() async {
    ...
    if (_formKey.currentState!.validate()) {
      //Ya ko data lai view model ma paass garne
      ref.
...
void initState() {
  super.initState();
  Future.microtask(() {
    ref.read(BatchViewmodelProvider.notifier).getAllBatch();
  });
}
...
// if (batchState.status == BatchStatus.laoded) {
